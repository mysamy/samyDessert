 ...
 */
final class Version20260313102627 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD telephone VARCHAR(20) DEFAULT NULL, ADD adresse VARCHAR(255) DEFAULT NULL, ADD ville VARCHAR(100) DEFAULT NULL, ADD code_postal VARCHAR(10) DEFAULT NULL, CHANGE mot_de_passe password VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE utilisateur DROP telephone, DROP adresse, DROP ville, DROP code_postal, CHANGE password mot_de_passe VARCHAR(255) NOT NULL');
